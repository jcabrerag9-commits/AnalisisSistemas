                    ...
                    <table className="w-full border-collapse text-sm">
                        <thead>
                            <tr className="bg-zinc-50 border-b border-zinc-200">
                                <th className="px-4 py-3 text-left text-xs font-semibold text-zinc-500 uppercase tracking-wide">Estado Asiento</th>
                        ...
                        <tbody className="divide-y divide-zinc-100">
                            {filteredData.map(item => (
                                <tr key={item.ESA_ESTADO_ASIENTO} className="bg-white hover:bg-zinc-50 transition-colors">
                                    ...
                                    <td className="px-4 py-3 text-sm text-zinc-700">{item.ESA_DESCRIPCION}</td>
                                    <td className="px-4 py-3">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button className="inline-flex items-center px-2.5 py-1 rounded text-xs font-medium bg-red-50 text-red-700 border border-red-200 hover:bg-red-100 transition-colors" onClick={() => handleDelete(item.ESA_ESTADO_ASIENTO)}>
                                                Eliminar
                                            </button>
                                        </div>
                                    </td>
