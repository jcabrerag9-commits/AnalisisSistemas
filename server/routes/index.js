...
// ← NUEVA: Balanza de Comprobación
const REPORTE_BALANZARoute         = require('./REPORTE_BALANZA');
 router.use('/reportes', REPORTE_BALANZARoute);

const REPORTE_ESTADO_RESULTADOSRoute = require('./REPORTE_ESTADO_RESULTADOS');
 router.use('/reportes', REPORTE_ESTADO_RESULTADOSRoute);

// ← NUEVO: Libro de IVA (Compras y Ventas)
const REPORTE_LIBRO_IVARoute = require('./REPORTE_LIBRO_IVA');
 router.use('/reportes', REPORTE_LIBRO_IVARoute);

// ← NUEVO: Flujo de Efectivo
const REPORTE_FLUJO_EFECTIVORoute = require('./REPORTE_FLUJO_EFECTIVO');
 router.use('/reportes', REPORTE_FLUJO_EFECTIVORoute);

// ← NUEVO: Cierre Anual
const CIERRE_ANUALRoute = require('./CIERRE_ANUAL');
 router.use('/operaciones', CIERRE_ANUALRoute);
