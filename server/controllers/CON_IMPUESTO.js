...
exports.create = async (req, res) => {
    try {
        ...
        const sql = `INSERT INTO CON_IMPUESTO (CUE_CUENTA, IMP_CODIGO, IMP_NOMBRE, IMP_PORCENTAJE, IMP_FECHA_VIGENCIA_INICIO, IMP_FECHA_VIGENCIA_FIN, IMP_ESTADO) VALUES (:CUE_CUENTA, :IMP_CODIGO, :IMP_NOMBRE, :IMP_PORCENTAJE, :IMP_FECHA_VIGENCIA_INICIO, :IMP_FECHA_VIGENCIA_FIN, :IMP_ESTADO)`;
...
exports.update = async (req, res) => {
    try {
        const id = req.params.id;
        const { CUE_CUENTA, IMP_CODIGO, IMP_NOMBRE, IMP_PORCENTAJE, IMP_FECHA_VIGENCIA_INICIO, IMP_FECHA_VIGENCIA_FIN, IMP_ESTADO } = req.body;
        const sql = `UPDATE CON_IMPUESTO SET CUE_CUENTA = :CUE_CUENTA, IMP_CODIGO = :IMP_CODIGO, IMP_NOMBRE = :IMP_NOMBRE, IMP_PORCENTAJE = :IMP_PORCENTAJE, IMP_FECHA_VIGENCIA_INICIO = :IMP_FECHA_VIGENCIA_INICIO, IMP_FECHA_VIGENCIA_FIN = :IMP_FECHA_VIGENCIA_FIN, IMP_ESTADO = :IMP_ESTADO WHERE IMP_IMPUESTO = :id`;
